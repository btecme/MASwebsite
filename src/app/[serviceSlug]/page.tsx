  ...
  return (
    <main>
      <Hero
        ...
        highlights={["Local service", "Flexible storage options", "Fast path to availability"]}
          ...
          <div className="grid gap-4">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-slate-950 p-6 text-white shadow-[0_22px_70px_rgba(15,23,42,0.18)]">
              ...
              <p className="mt-3 text-base leading-7 text-slate-300">
                Call the office or use the request form to ask about availability, pricing, and the best option for your storage needs.
              </p>
